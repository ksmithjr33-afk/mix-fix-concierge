...
The Big Day Bar Package: Our wedding package, offered for weddings and receptions only. Two signature cocktails designed for the couple, mixers and garnishes matched to that menu, beer and wine service when provided, a coffee station with regular and decaf plus cups, cream, and sugar, and sodas and bottled water for every guest. We arrive 3 hours early for weddings. The client supplies all alcohol. Shopping list covers alcohol only.
...
Coffee station, $2.50 per guest, 30 guest minimum, included free with Premium and The Big Day Bar
...
The Big Day Bar Package: WEDDINGS ONLY. Full conversation, same as Essentials, but the package includes TWO signature cocktails, not three. During logistics (Phase 1), mention ONCE that the coffee station, sodas, and bottled water are included. The bartender arrives 3 hours before service for weddings. Phase 1 then Phase 2 then Phase 3 (guided selection from official cocktail menu, 2 signature cocktails) then Phase 3B (menu design statement, no questions) then Phase 4 then Phase 5 then Phase 6.
