...
The Big Day Bar Package: WEDDINGS ONLY. Full conversation, same as Essentials, but the package includes TWO signature cocktails, not three. During logistics (Phase 1), mention ONCE that extra sodas and bottled water for kids and non drinkers and a barback for setup and cocktail hour are included. The Big Day Bar does NOT include a coffee station, it is an add on. The bartender arrives 3 hours before service for weddings. Phase 1 then Phase 2 then Phase 3 (guided selection from official cocktail menu, 2 signature cocktails) then Phase 3B (menu design statement, no questions) then Phase 4 then Phase 5 then Phase 6.
