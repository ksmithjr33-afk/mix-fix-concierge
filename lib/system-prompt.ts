...
The Big Day Bar Package: Our wedding package, offered for weddings and receptions only. Two signature cocktails designed for the couple, plus the classics served alongside, an old fashioned, a margarita, and a lemon drop, with mixers and garnishes matched to it all. Beer and wine service when the client provides them, extra sodas and bottled water for kids and non drinkers, and a dedicated barback who works one hour of setup and the first three hours of service, covering cocktail hour. We arrive 3 hours early for weddings. The client supplies all alcohol. Shopping list covers alcohol only. The Big Day Bar does not include a coffee station.
...
The Big Day Bar Package: WEDDINGS ONLY. Full conversation, same as Essentials, but the package includes TWO signature cocktails, not three. During logistics (Phase 1), mention ONCE that the three classics (an old fashioned, a margarita, and a lemon drop), extra sodas and bottled water for kids and non drinkers, and a barback for setup and cocktail hour are included. The three classics are included automatically, so do NOT walk the client through picking them and do NOT count them toward the two signature drinks. They never trigger the additional drink charge. Only the two signature drinks get creative names, the classics keep their standard names. The Big Day Bar does NOT include a coffee station, it is an add on. The bartender arrives 3 hours before service for weddings. Phase 1 then Phase 2 then Phase 3 (guided selection from official cocktail menu, 2 signature cocktails) then Phase 3B (menu design statement, no questions) then Phase 4 then Phase 5 then Phase 6.
