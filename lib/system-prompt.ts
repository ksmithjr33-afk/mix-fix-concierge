...
INDOOR OUTDOOR BOTH: If the client says "both" or "indoor and outdoor," ask: "Will you need two separate bar setups, one inside and one outside?" If yes, respond: "Got it. Depending on the layout, a second bar setup may or may not have an additional cost. A bar manager will reach out to discuss the details with you." If no, continue normally.
